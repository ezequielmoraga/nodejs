...
solucion: meto en una funcion el atender las solicitudes, y la funcion
//la disparo demorada.
...
//La planifico para al menos dentro de 500ms, luego se ejecute el archivo
//supongo que calcule bien y estara cargado
setTimeout(()=>{
    atiende_argumentos();
},1000);

//Nada elegante, puede fallar si crece tamaño de archivo o compu ocupada.